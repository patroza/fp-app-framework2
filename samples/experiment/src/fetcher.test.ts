...
type GetUserResult =
  ...
  | { code: 401; payload: readonly [Error, string] } // 401 Unauthorized – we tried requesting a resource we don't have access to
...
it("works", async () => {
  // validators for 200 and 422 responses.
  ...
  const [n, errors] =
    ...
    await new Fetcher<GetUserResult, string>(
